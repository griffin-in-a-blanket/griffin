...
export const questions = [
  {
    ...
    answer: "D",
    excerpt:
      "Yup. You can get him all the toys in a world but at 4AM, all you hear is the sound of a bottle cap sliding around on the floor.",
    img: cap,
    alt: "2 bottle caps",
  },
  {
    id: 1,
    question:
      "Griffin does not usually knock items off a table unless it's a(n)...",
    A: "iPhone",
    B: "ice cube",
    C: "picture frame",
    D: "bottles",
    answer: "B",
    excerpt:
      "We don't know what Griffin has against ice cubes. He should /chill/ out.",
    img: ice,
  ...
  },
  {
    ...
    answer: "B",
    excerpt:
      "It would be awesome if Griffin can use the toilet but giving his paw is pretty cool too.",
    img: paw,
