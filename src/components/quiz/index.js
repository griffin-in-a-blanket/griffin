    ...
    return (
      <div className="quiz-container">
        ...
        <div className="subtitle">
          Now that you kinda know how Griffin is like, test your cat knowledge
          with this 3 question quiz
        </div>
        <Modal
          isOpen={modalIsOpen}
          style={customStyles}
            ...
            <div className="question-container" key={q.id}>
              ...
              <div className="container">
                <div className="answers-container">
                  <button
                    disabled={answered[q.id] ? "disabled" : ""}
                    className="answer"
                    onClick={() => {
                      this.handleClick(q["A"], q)
                      this.openModal()
                    }}
                    style={{
                      opacity: answered[q.id] && q.answer !== "A" ? "0.5" : "",
                    }}
                  >
                    A. {q["A"]}
                  </button>
                  <button
                    ...
                    className="answer"
                    onClick={() => {
                      this.handleClick(q["B"], q)
                      this.openModal()
                    }}
                    style={{
                      opacity: answered[q.id] && q.answer !== "B" ? "0.5" : "",
                    }}
                  >
                    B. {q["B"]}
                  </button>
                  <button
                    ...
                    className="answer"
                    onClick={() => {
                      this.handleClick(q["C"], q)
                      this.openModal()
                    }}
                    style={{
                      opacity: answered[q.id] && q.answer !== "C" ? "0.5" : "",
                    }}
                  >
                    C. {q["C"]}
                  </button>
                  <button
                    ...
                    className="answer"
                    onClick={() => {
                      this.handleClick(q["D"], q)
                      this.openModal()
                    }}
                    style={{
                      opacity: answered[q.id] && q.answer !== "D" ? "0.5" : "",
                    }}
                  >
                    D. {q["D"]}
                  </button>
